 ...
 * generated in the com.hr.ws.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetOrderById_QNAME = new QName("http://ws.ws.hr.com/", "getOrderById");
    private final static QName _GetOrderByIdResponse_QNAME = new QName("http://ws.ws.hr.com/", "getOrderByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hr.ws.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ws.hr.com/", name = "getOrderById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ws.hr.com/", name = "getOrderByIdResponse")
