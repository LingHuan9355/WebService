 ...
 * 2018-05-14T18:18:35.832+08:00
 * Generated source version: 2.5.9
 * 
 */
@WebServiceClient(name = "DataTypeWSImplService", 
                  wsdlLocation = "http://192.168.0.100:8888/180512WebService2_ws_cxf/datatypews?wsdl",
                  targetNamespace = "http://ws2.ws.hr.com/") 
public class DataTypeWSImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ws2.ws.hr.com/", "DataTypeWSImplService");
    public final static QName DataTypeWSImplPort = new QName("http://ws2.ws.hr.com/", "DataTypeWSImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.0.100:8888/180512WebService2_ws_cxf/datatypews?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(DataTypeWSImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.0.100:8888/180512WebService2_ws_cxf/datatypews?wsdl");
        }
        WSDL_LOCATION = url;
    }
