 ...
 * 2018-05-24T14:39:46.921+08:00
 * Generated source version: 2.5.9
 * 
 */
@WebServiceClient(name = "OrderWSImplService", 
                  wsdlLocation = "http://localhost:8080/180520WebService4_ws_cxf_spring/orderws?wsdl",
                  targetNamespace = "http://ws.ws.hr.com/") 
public class OrderWSImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ws.ws.hr.com/", "OrderWSImplService");
    public final static QName OrderWSImplPort = new QName("http://ws.ws.hr.com/", "OrderWSImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/180520WebService4_ws_cxf_spring/orderws?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(OrderWSImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/180520WebService4_ws_cxf_spring/orderws?wsdl");
        }
        WSDL_LOCATION = url;
    }
