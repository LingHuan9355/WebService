 ...
 * 2018-05-14T18:25:01.174+08:00
 * Generated source version: 2.5.9
 * 
 */
@WebServiceClient(name = "HelloWSImplService", 
                  wsdlLocation = "http://192.168.0.100:8989/1805012WebService2_ws/hellows?wsdl",
                  targetNamespace = "http://ws.ws.hr.com/") 
public class HelloWSImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ws.ws.hr.com/", "HelloWSImplService");
    public final static QName HelloWSImplPort = new QName("http://ws.ws.hr.com/", "HelloWSImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.0.100:8989/1805012WebService2_ws/hellows?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWSImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.0.100:8989/1805012WebService2_ws/hellows?wsdl");
        }
        WSDL_LOCATION = url;
    }
