 ...
 * 2018-05-12T19:25:48.049+08:00
 * Generated source version: 2.5.9
 * 
 */
@WebServiceClient(name = "HelloWSImplService", 
                  wsdlLocation = "http://192.168.0.103:8888/180509WebService1_ws/hellows?wsdl",
                  targetNamespace = "http://ws.hr.com/") 
public class HelloWSImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ws.hr.com/", "HelloWSImplService");
    public final static QName HelloWSImplPort = new QName("http://ws.hr.com/", "HelloWSImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.0.103:8888/180509WebService1_ws/hellows?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWSImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.0.103:8888/180509WebService1_ws/hellows?wsdl");
        }
        WSDL_LOCATION = url;
    }
