 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://ws.hr.com/", wsdlLocation = "file:/D:/Maven_WorkSpace/180511WebService1_ws_client2/hellows.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://ws.hr.com/", "HelloWSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/Maven_WorkSpace/180511WebService1_ws_client2/hellows.wsdl");
    ...
    public HelloWSImpl getHelloWSImplPort() {
        return super.getPort(new QName("http://ws.hr.com/", "HelloWSImplPort"), HelloWSImpl.class);
    }
    ...
    public HelloWSImpl getHelloWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.hr.com/", "HelloWSImplPort"), HelloWSImpl.class, features);
    }
